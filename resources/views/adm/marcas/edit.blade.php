            ...
            <form method="POST"  enctype="multipart/form-data" action="{{action('MarcaController@update', $marca->id)}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        ...
                        <input id="icon_prefix" type="text" class="validate" name="nombre"  value="{{ $marca->nombre }}">
                        <label for="icon_prefix">Nombre</label>
                    </div>
                    <div class="input-field col s6">
                        <i class="material-icons prefix">text_rotation_none</i>
                        <input id="icon_prefix" type="text" class="validate" name="orden"  value="{{ $marca->orden }}">
