            ...
            <table class="index-table-logos responsive-table ">
                ...
                @forelse($destacados as $d)
                    <tr>
                        ...
                        <td style="width: 200px;">{{ $d->producto->nombre }}</td>
                        <td>{{ $d->orden }}</td>
                        <td>
                            <a href=" {{ route('destacado.productos.edit', $d->id)}} " class="btn-floating btn-large waves-effect waves-light orange"><i class="material-icons">autorenew</i></a>
